...
function readBlob() {
  ...
  */
  ...
  document.getElementById("file").querySelector('span').innerHTML = "";
}
  ...
  ws.onmessage = function(e) {
    ...
    if (message.type == "file") {
      ...
      if (message.number == "-1") {
        ...
        if (message.MIME == "txt") {
          output("["+message.time+"] <font color=\""+message.user_color+"\">"+message.username+"</font>: "+"<div id=\"text-block\"><pre>"+message.show_filename+"\n"+atob(str)+"</pre></div>");
      ...
      output("<div><font color=\""+message.user_color+"\">"+message.username+"</font><sub><sub> "+message.time+"</sub></sub>: "+message.data+"</div>")
    }
